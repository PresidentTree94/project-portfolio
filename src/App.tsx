...
function App() {
  ...
  const projects: Application[] = [
    ...
    {title: "Mythic Realms", description: "A web application for organizing kingdoms, characters, and myths for a fantasy medieval worldbuilding project.", skills: ["Next.js", "Tailwind", "Typescript", "Vercel", "Supabase"]},
    {title: "Form Utils", description: "A tiny, type-safe form-handling utility that turns objects and schema into a fully typed form system with parsing and update helpers.", skills: ["Typescript"]}
  ]
