...
function Project({ data }:Readonly<{ data: Application }>) {
  return (
    <a href={data.link} target="_blank" rel="noopener noreferrer" className="card flex flex-col justify-between shadow p-6 group transition-all hover:shadow-xl hover:border-primary/50 hover:-translate-y-1">
      <div>
