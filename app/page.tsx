...
const projects = [
  {
    ...
    link: "https://karlydev.vercel.app/"
  },
  {
    title: "Form Utils",
    ...
    skills: ["Typescript"],
    link: "https://github.com/PresidentTree94/form-utils"
  }
];
...
export default function Home() {
  return (
    <main className="mt-16 px-8 py-16 sm:px-16 space-y-16">
      <section className="flex flex-col-reverse lg:flex-row items-center gap-10 sm:gap-18">
