...
## Details
The portfolio is a single-page application that leads to all of my other GitHub repositories. Most of the HTML is in App.js, while most of the CSS is in index.css. The components, Skill and Website, have their respective HTML and use styled-components for the CSS. 
